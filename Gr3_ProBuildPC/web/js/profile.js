document.addEventListener("DOMContentLoaded", function() {
    ...
    const revalidatePassFields = () => {
        ...
        if (newPasswordInput.value || currentPasswordInput.value || confirmPasswordInput.value) {
            if (newPasswordInput.classList.contains('is-invalid') || newPasswordInput.value) {
            ...
            if (currentPasswordInput.classList.contains('is-invalid') || currentPasswordInput.value) {
