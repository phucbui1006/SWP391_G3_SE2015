...
<% 
    ...
    if (addTemplates == null) {
        addTemplates = Collections.emptyList();
    }
%>
...
<html lang="vi">
    ...
    <body class="admin-category-body">
        ...
        <main class="admin-category-container">
            ...
            <% if (addCategory != null) { %>
            <form action="<%= contextPath %>/admin/category/add" method="post" id="addCategoryForm" novalidate>
                ...
                <div class="form-section-card">
                    ...
                    <div class="form-grid">
                        <div class="cat-form-group">
                            ...
                            <input id="categoryName" name="categoryName" type="text" value="<%= h(addCategory.getCategoryName()) %>" placeholder="VD: Card đồ họa, Bo mạch chủ, Nguồn máy tính..." required minlength="2" maxlength="100">
                        </div>
                    </div>
                </div>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <% } else { %>
                                                ...
                                                <button type="submit" name="action" value="toggleRequired_<%= i %>" class="toggle-switch-btn <%= t.isRequired() ? "active" : "" %>" title="Nhấp để đổi trạng thái Bắt buộc">
                                                    ...
                                                    <span class="toggle-label"><%= t.isRequired() ? "Bắt buộc" : "Tùy chọn" %></span>
                                                </button>
                                            <% } %>
                                        </td>
